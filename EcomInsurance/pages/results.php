    ...
    <body>
        ...
        <div id="wrapper">
            ...
            //posting the categories
                ...
                //search database
                $query = "select * from products where category='$category' order by percentage ASC";
                ...
                if ($result) {
                    ...
                    if ($result->num_rows > 0) { 
                        echo "<div class=\"wrapper\"><div class=\"btn btn-success form-control col-lg-12\"><p>Total Results Found</p></div></div>";
                    ...
                    <div class=\"col-lg-4\">
                        ...
                        <table class=\"table-responsive\" border=\"2\" cellpadding=\"5\">
                            ...
                            <tr>
                                <td>$row->type</td>
                                <td>Ksh.  $row->windscreen</td>
                                <td>Ksh.  $row->towing</td>
                                <td>Ksh.  ($row->percentage/100*$amount)</td>
                            </tr>
                        </table>
                        </div>
                    </div>
                    <div class=\"col-lg-4\">
                        ...
                        <div class=\"panel-body\">
                            ...
                            <a href=\"pay.php?pid='$row->pid'\"><button class=\"btn-primary\" type=\"submit\"/>Buy Quote</button></a>
                        </div>
                    </div>
