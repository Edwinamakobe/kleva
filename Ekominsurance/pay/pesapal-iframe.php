...
$email = $_POST['email'];
$phonenumber = '0703317887';//ONE of email or phonenumber is required

$callback_url = 'localhost/pasapal/callback.php'; //redirect url, the page that will handle the response from pesapal.
